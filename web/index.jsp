...
<main role="main">
      ...
      <div class="jumbotron">
        <div class="container">
          <h1 class="display-3">POO 2018-II Entrega III</h1>
          <p>Por favor inicie el proyecto ingresando el numero del cementerio al cual desea ingresar.</p><br>
          <p><c:if test="${!empty cementerios}"> <center>${cementerios}</center></c:if></p>
        </div>
      </div>
